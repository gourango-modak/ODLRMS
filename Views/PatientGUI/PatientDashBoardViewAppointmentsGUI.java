 ...
 * @author sajib
 */
public class PatientDashBoardViewAppointmentsGUI extends javax.swing.JFrame {

    Connection con;
    PreparedStatement ps;
    ResultSet rs;
    protected static String select_App_ID;
    
    public PatientDashBoardViewAppointmentsGUI() {
        initComponents();
    ...
    private void initComponents() {
        ...
        AppointmentNo.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Select App No" }));
        ...
        getContentPane().add(SubmitLabel, new org.netbeans.lib.awtextra.AbsoluteConstraints(515, 279, 55, 30));

        BackgroundImageLabel.setIcon(new javax.swing.ImageIcon(getClass().getResource("/img/PatientImg/PatientDashBoardViewAppointmentsGUI.png"))); // NOI18N
    ...
    private void SubmitLabelMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_SubmitLabelMouseClicked
        ...
        select_App_ID = AppointmentNo.getSelectedItem().toString();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(PatientDashBoardViewAppointmentsGUI.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
