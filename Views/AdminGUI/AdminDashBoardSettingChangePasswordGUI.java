...
public class AdminDashBoardSettingChangePasswordGUI extends javax.swing.JFrame {
    ...
    public AdminDashBoardSettingChangePasswordGUI() {
        initComponents();
    ...
    private void initComponents() {
        ...
        BackgroundImageLabel.setIcon(new javax.swing.ImageIcon(getClass().getResource("/img/AdminImg/AdminDashBoardSettingChangePasswordGUI.png"))); // NOI18N
    ...
    private void OkMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_OkMouseClicked
        ...
        if(isValidCurPass()){
            if(pass1.equals(pass2)){
                if(con != null) {
                    try {
                        ps = con.prepareStatement("UPDATE `admin` SET `password`=? WHERE a_id = ?");
                        ps.setInt(2, Integer.valueOf(HomePageAdminLoginGUI.logedINAdminID));
    ...
    private boolean isValidCurPass() {
        try {
            ps = con.prepareStatement("Select password from admin where a_id = ?");
            ps.setInt(1, Integer.valueOf(HomePageAdminLoginGUI.logedINAdminID));
            rs = ps.executeQuery();
            rs.next();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(AdminDashBoardSettingChangePasswordGUI.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
